...
namespace AzureFunctionApp
{
    public class DataFactoryService
    {
        ...
        public static void StartPipeline(string inputBlobFile, string inputBlobPath, string outputBlobDestination,string pipelineName, string resourceGroup, string dataFactoryName, string subscriptionId, Microsoft.Extensions.Logging.ILogger log)
        {
            ...
            Dictionary<string, object> parameters = new Dictionary<string, object>
                {
                    { "inputFile", inputBlobFile },
                    { "inputPath", inputBlobPath },
                    { "outputDestination", outputBlobDestination }
